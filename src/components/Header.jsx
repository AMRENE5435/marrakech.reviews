...
import { Search, Menu, X, MapPin, Star } from 'lucide-react'
          ...
          <div className="hidden md:flex items-center space-x-3">
            <div className="relative">
              ...
              <input
                ...
                className="pl-10 pr-4 py-2 bg-background border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-accent text-sm"
              />
            </div>
